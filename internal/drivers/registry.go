...
func NewRegistry() Registry {
	agents := []runtime.Agent{
		...
		nativeAgent("pi", "Pi Coding Agent", "pi", "@mariozechner/pi-coding-agent", PiModels{Plan: runtime.CommandPlan{Executable: "pi", Args: []string{"--list-models"}}, Providers: PiAuthFileProviders{}}, true, PiSDKAuth{ProviderAuth: ProviderAuth{NativeAuth: NativeAuth{LogoutCommand: runtime.CommandPlan{Executable: "pi"}, LogoutInstruction: "Run /logout in Pi and select the provider."}, Providers: PiAuthFileProviders{}}}),
	}
