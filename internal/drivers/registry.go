...
func NewRegistry() Registry {
	agents := []runtime.Agent{
		...
		{ID: "dsh", Name: "DeepSeek Harness", Binary: "dsh", Launch: NativeLaunch{Binary: "dsh"}, Install: NPMPackage{Package: "@deepseek-ai/dsh"}, Capabilities: []runtime.Capability{runtime.CapabilityLaunch}},
